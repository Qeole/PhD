...
\hypersetup{%
    ...
    pdfstartpage  = 1,
    pdfcreator    = {Vim, gnuplot, dia, LaTeX (XeLaTeX), et tout un tas de paquets !},
    %pdfproducer   = {\LaTeX{}},% Contient automatiquement le compilateur
    bookmarksopen = true,
    bookmarksdepth= 2,
    pdfauthor     = {Quentin MONNET},
    pdftitle      = {Modèles et mécanismes pour la protection contre les attaques de déni de service dans les réseaux de capteurs sans fil},
    pdfsubject    = {Thése de doctorat en informatique, Université Paris-Est},
    pdfkeywords   = {Réseaux de capteurs sans fil~; Sécurité~; Déni de service~; Modélisation}
}
