...
\footnote{%
    ...
    En l'état actuel je suppose, sans avoir réussi à le vérifier, que le nom de l'attaque \textit{sinkhole} provient de la station de base, souvent appelée « puits » ou \textit{sink}, dont le nœud compromis se fait passer pour un voisin immédiat lors de l'attaque, et qu'il « remplace » en quelque sorte.%
}.
...
Du point de vue de l'attaquant les techniques de brouillage « intelligentes » peuvent nécessiter des ajustements en fonction du protocole MAC employé dans le réseau, et mieux vaut mener des tests pour s'assurer que les attaques fonctionnent correctement.
...
Il n'est pas évident de trouver un intérêt concret aux comportements cupides dans les réseaux de capteurs en dehors de la collecte parasite d'informations.
