...
Elles peuvent être utilisées pour neutraliser la remontée d'informations, mais une fois encore, on leur préférera dans ce contexte des attaques de \idx{brouillage}.
