...
\paragraph{Selon l'objet de la surveillance}
...
%{{{2
\paragraph{Détection basée sur les anomalies} jhkfds hife hgfudgh jdgh fdighdsmgji kdfgjfdk mhgdsgkh dkgmh.
dsfgje gofigj odgj iogj ojeogj odf
...
%{{{2
Nous allons donner ici quelques exemples de propositions concrètes de systèmes de détection d'intrusion.
