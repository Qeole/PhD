...
La \tabref{ea:tab:paradigm} située plus bas présente un classement des attaques que nous allons évoquer selon ces paradigmes.
...
\begin{table}[!ht]
    ...
    \medskip
    \begin{small}
        \begin{tabular}{m{.3\textwidth}|m{.63\textwidth}}
            \toprule
