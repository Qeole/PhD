...
Outre les systèmes de détection d'intrusion machine, qui surveillent le système d'exploitation du nœud même sur lequel ils s'exécutent, il est possible de faire vérifier l'intégrité des systèmes par d'autres entités.
...
\paragraph{}
Plusieurs études ont tenté d'établir une synthèse des solutions proposées en termes de systèmes de détection d'intrusion~\cite{ME13,MS14}, et fournissent de nombreux autres exemples.
