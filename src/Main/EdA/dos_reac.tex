...
Lorsque toute une zone du réseau est sous l'effet d'une attaque de brouillage et se retrouve coupé de la \sdb, une possibilité intéressante est d'établir un « trou de ver », légitime cette fois-ci, entre un relais de la zone atteinte et un nœud extérieur, qui sert alors de passerelle vers le reste du réseau~\cite{CCH07}.
...
En dehors de ce tunnel, les dispositions évoquées jusque là pour échapper au brouillage sont très couteuses pour des \rcs, car elles demandent un équipement ou bien une capacité de calculs conséquents.
...
%{{{2
Il existe, liée aux IDS, une notion intéressante de « confiance » qui peut être mise en place dans un \rc.
