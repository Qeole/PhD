...
Plutôt que de considérer les capteurs « tout blanc » ou « tout noir », beaucoup de systèmes de détection leur attribue un score de « réputation », qui évolue dans le temps, et reflète la « confiance » (en anglais: \textit{trust}) que l'on peut avoir en tel nœud.
