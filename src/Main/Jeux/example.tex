...
En pratique, certains de ces états ne seront jamais atteints: par exemple, un état où tous les joueurs\index{joueur} sont simultanément en train de traiter les paquets reçus n'aurait pas de sens, puisqu'il faudrait qu'au moins l'un d'entre eux ait émis ces paquets au tour précédent, et devrait désormais se retrouver au repos.
...
Elles correspondent aux arêtes empruntées par les joueurs\index{joueur} sur leurs propres machines à états, auxquelles seraient ajoutées des valeur nulles en \idx{gain} et en énergie pour les deux autres joueurs\index{joueur} qui attendent leur tour.
