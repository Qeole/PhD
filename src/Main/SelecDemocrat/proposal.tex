...
\begin{itemize}
    ...
    \item $\mathit{ÉCe}$ et $\mathit{ÉCa}$ sont des variables contenant les valeurs d'\underline{é}nergie \underline{c}onsommée \underline{e}ffec\-tive et \underline{a}nnoncée (respectivement); plus de détails sont fournis un peu plus bas.
\end{itemize}
