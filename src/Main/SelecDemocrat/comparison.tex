...
\begin{itemize}
    ...
    \item l'un se base sur un processus de renouvellement aléatoire tel que présenté au \chapref{sa} (\idrand);
    \item l'un se base sur un renouvellement selon l'énergie résiduelle (avec usage de \vns) tel que présenté au \chapref{se} (\ideres);
