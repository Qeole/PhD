...
Elle est très faible; mais il ne faut pas oublier que «surveillance» n'est pas systématiquement égale à «détection» (si un \cn manque trop de paquets en raison de collisions\index{collision} dans le réseau, par exemple).
