...
Ces contributions sont principalement centrées sur le \idx{renouvellement} et l'établissement d'un processus efficace de sélection\index{selection@sélection} pour les nœuds de surveillance d'un \rcs.
