...
Sauf indication contraire, les travaux exposés dans le présent chapitre, ainsi d'ailleurs que dans les \chapref{se} et~\ref{chap:sd}, reposent sur les hypothèses suivantes:
\begin{itemize}
...
La seconde méthode proposée consiste à décharger les nœuds du processus d'auto-désignation, pour le remplacer par une nomination autoritaire réalisée par les $2$-\chs (voir \figref{sa:fig:elecch}).
