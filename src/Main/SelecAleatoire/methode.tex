...
\section{Détection des attaques de \dds}
...
Le fait de clusteriser le \rc tel que présenté en \ssref{st:subsec:partition} permet de limiter la consommation en énergie de la plupart des nœuds du réseau, puisque seuls les \chs se retrouvent à effectuer des émissions sur des distances plus longues que le rayon d'un cluster.
...
\nomenclature{MLGG}{\textit{Multiplicative Linear-Congruential Generators}}
