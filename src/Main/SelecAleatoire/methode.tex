...
Il est vrai que le renouvellement périodique\index{renouvellement!renouvellement périodique} des \cns rajoute des contraintes et augmente le volume des messages de contrôles à échanger dans le réseau.
...
\end{itemize}
alors la dynamique et les méthodes de sélection\index{selection@sélection} présentés dans cette thèse peuvent très bien être mis en œuvre pour optimiser détection et consommation.
