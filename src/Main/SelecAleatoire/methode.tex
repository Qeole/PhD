...
Mais tous les protocoles de clusterisation\index{clusterisation!protocole de clusterisation} ne prévoient pas nécessairement de renouvellement régulier de la partition.
...
Si bien que l'élection des \cns ne prend en compte à aucun moment la \idx{clusterisation} du réseau.
